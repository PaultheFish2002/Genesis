...
def get_cfgs():
    ...
    drone_cfg = {
        ...
        "rpm_scale" : [0.5, 1.5],
        "swarm_num_drone" : 1, # 此处决定 是单机框架还是多机框架
        "swarm_init_offset": 1.0,
        "swarm_init_random_bias": 0.2, # random bias 
    }
    obs_cfg = {
        "num_obs": 17,
        "obs_scales": {
    ...
    return env_cfg, drone_cfg, obs_cfg, reward_cfg, command_cfg
...
def main():
    ...
    env_cfg, drone_cfg, obs_cfg, reward_cfg, command_cfg = get_cfgs()
    ...
    pickle.dump(
        [env_cfg, drone_cfg, obs_cfg, reward_cfg, command_cfg, train_cfg],
